    ...
    <div className="text-white fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      ...
      >
        ...
        <button
          ...
          onClick={() => setPostZoomState(false)} // Toggle the state to close
        >
        ...
        <div className="md:w-1/2 p-4">
          ...
          {/* Post Caption */}
          <p className="mb-4">
            <span className="font-semibold">tf.vikram_</span> Just posting these as a checkpoint for
            where I would reach...gotta know na where it all started!!!
          </p>
          ...
          <div className="space-y-4">
            <div>
              <p>
                <span className="font-semibold">rajveer_thakur_2003</span> A goood starting point🔥
              </p>
            </div>
            <div>
              <p>
                <span className="font-semibold">_debagyanb_</span> Fitness partners before you hire
                me as a script writer
              </p>
            ...
            <div>
              <p>
                <span className="font-semibold">tushar__17</span> Bro ❤️🔥
              </p>
            </div>
            <div>
              <p>
                <span className="font-semibold">chirag.1503</span> Mera maal, mera maal😅
              </p>
            </div>
            <div>
              <p>
            ...
            <div>
              <p>
                <span className="font-semibold">_hitesh_singh</span> Mote
              </p>
            </div>
          </div>
          ...
          <div className="mt-4">
            <p className="text-gray-500">
              Liked by <span className="font-semibold">e.k.k.u.18</span> and 68 others
            </p>
